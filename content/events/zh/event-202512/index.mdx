...
description: >-
  参与 IvorySQL 文档共建计划，提交 PR 或 Issue，赢取 Beats 耳机、机械键盘等多重好礼。
slug: "event-202512"
---
...
>
> 注：此活动相关的 PR，请提交到 [master](https://github.com/IvorySQL/ivorysql_docs/tree/master/CN/modules/ROOT/pages/master) 分支下。
...
**1. 参与本活动需要什么条件？**
需要有 GitHub 账号，在提交 PR 前阅读 [IvorySQL 贡献流程指南](https://docs.ivorysql.org/cn/ivorysql-doc/master/8.1)，并签署贡献者许可协议（CLA）。为了大家更流畅的撰写文档，请阅读 [文档语法参考](https://docs.ivorysql.org/cn/ivorysql-doc/master/8.2)。
