...
author: "official"
category: IvorySQL
image: "/images/blog/covers/upgrade-guide.svg"
tags: [IvorySQL, Database, Oracle Compatible, PostgreSQL]
description: "Complete upgrade guide from IvorySQL 3.x to the major 4.0 release."
---
...
![img](/images/blog/2025-01-02-ivorysql-upgrade-3.x-to-4.0/up-to-4.0-1.png)

Then, install the new version of the IvorySQL 4.0 database:

![img](/images/blog/2025-01-02-ivorysql-upgrade-3.x-to-4.0/up-to-4.0-2.png)

Initialize the new IvorySQL 4.0 data directory:

![img](/images/blog/2025-01-02-ivorysql-upgrade-3.x-to-4.0/up-to-4.0-3.png)

Check version compatibility:

![img](/images/blog/2025-01-02-ivorysql-upgrade-3.x-to-4.0/up-to-4.0-4.png)
...
![img](/images/blog/2025-01-02-ivorysql-upgrade-3.x-to-4.0/up-to-4.0-5.png)

![img](/images/blog/2025-01-02-ivorysql-upgrade-3.x-to-4.0/up-to-4.0-6.png)
...
![img](/images/blog/2025-01-02-ivorysql-upgrade-3.x-to-4.0/up-to-4.0-7.png)

Manually run the `vacuum` command:

![img](/images/blog/2025-01-02-ivorysql-upgrade-3.x-to-4.0/up-to-4.0-8.png)

## Post-Upgrade Cleanup

After confirming there are no issues, delete the old database:

![img](/images/blog/2025-01-02-ivorysql-upgrade-3.x-to-4.0/up-to-4.0-9.png)
