...
author: "陶郑"
category: IvorySQL
image: "/images/blog/covers/ivorysql-htap.png"
tags: [IvorySQL, HTAP, DuckDB, PostgreSQL, Lakehouse, Mooncake]
description: "How IvorySQL's HTAP real-time lakehouse access engine eliminates ETL by combining row and column storage in a single database."
---
