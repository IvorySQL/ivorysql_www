...
description: "A hands-on, real-machine test of pulling native PostgreSQL 18.4 images from the IvorySQL China mirror registry — every pitfall, from tag naming to PG18's breaking data-path change."
---
