...
author: "ZhangChen"
category: IvorySQL
image: "/images/blog/covers/oracle-compat-kernel-en.png"
tags: [IvorySQL, Oracle, PostgreSQL, Kernel, PL/iSQL, Migration]
description: "A source-level look at how IvorySQL achieves deep Oracle compatibility at the PostgreSQL kernel level — dual parsers, types, packages, and more."
---
