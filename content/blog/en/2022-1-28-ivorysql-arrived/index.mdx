...
description: "IvorySQL has officially arrived — introducing the open source Oracle-compatible PostgreSQL database."
---
...
IvorySQL comes with numerous Oracle compatibility features including Oracle style  **PACKAGES**, **DATA Types**, and **Conversion Functions**. For details of Oracle compatibility features in IvorySQL refer to *[IvorySQL documentation](https://docs.ivorysql.org/en/ivorysql-doc/v5.4/7.3)*   
