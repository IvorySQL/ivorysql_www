...
author: "official"
category: IvorySQL
image: "/images/blog/covers/wasm.svg"
tags: [IvorySQL, Database, Oracle Compatible, PostgreSQL, WasmEdge]
description: "IvorySQL-WASM enables browser-based database experience with zero installation using WebAssembly."
---
...
![img](/images/blog/2025-05-27-ivorysql-wasm/w-1.png)
...
![img](/images/blog/2025-05-27-ivorysql-wasm/w-2.png)
...
![img](/images/blog/2025-05-27-ivorysql-wasm/w-3.png)
...
2. IvorySQL uses dual ports. The default connection port is 1521. To log in via port 5432, exit psql in the shell terminal and execute:
   ...
   ![img](/images/blog/2025-05-27-ivorysql-wasm/w-4.png)
...
The IvorySQL-WASM Community Edition will be released alongside IvorySQL 4.5. For details, follow the [IvorySQL Official Website](https://www.ivorysql.org/).