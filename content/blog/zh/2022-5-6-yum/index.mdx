...
![yum](/images/blog/2022-5-6-yum/Y-a.png)
...
![yum](/images/blog/2022-5-6-yum/Y-b.png)
...
![yum](/images/blog/2022-5-6-yum/Y-c.png)

### 4.3 瀚高 developer 连接

瀚高developer是瀚高自主研发的一个工具，除了可以支持瀚高数据库，还支持PostgreSQL以及IvorySQL数据库。连接配置如下：

![yum](/images/blog/2022-5-6-yum/Y-d.png)
