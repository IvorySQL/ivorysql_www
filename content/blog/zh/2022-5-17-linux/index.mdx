...
description: "详细讲解如何在 Linux 环境下通过源码编译安装 IvorySQL 数据库。"
---
...
- 也可以打开网站链接：[https://gitee.com/IvorySQL/IvorySQL/blob/master/README.md](https://gitee.com/IvorySQL/IvorySQL/blob/master/README.md)。
